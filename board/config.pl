...
# System config
use constant ADMIN_PASS => 'root';	# Admin password. For fucks's sake, change this.
use constant SECRET => 'AXHDOuXHzVI5lofK1XjG7Sv8DSMxDXjBGolQGYmS3Ys5v8dq7YkZFhdjomB29GN9YDEQ606krGhKvCDFM5TcVNEBeID4xbE4h2WbXnt5LLz1e98TQywtfL0ACFSXVhcU';		# Cryptographic secret. CHANGE THIS to something totally random, and long.
